...
class redisTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->assertInstanceOf("\\mpr\\cache\\redis", $this->object);
    }
